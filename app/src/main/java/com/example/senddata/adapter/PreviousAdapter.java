...
public class PreviousAdapter extends RecyclerView.Adapter<PreviousAdapter.PreviousViewHolder> {
    ...
    @NonNull
    @Override
    public PreviousAdapter.PreviousViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.previous_details,parent,false);
        return new PreviousAdapter.PreviousViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PreviousAdapter.PreviousViewHolder holder, int position) {
